...
from .views import MusicdiaryViewSet, QuestionViewSet, SearchView, MyPageView, RandomQuestion, PastQuestion#, TodayQuestion, YesterdayQuestion
...
urlpatterns = [
    ...
    path('api/question/past', PastQuestion.as_view()), # 2,3,4일 전 질문
]
